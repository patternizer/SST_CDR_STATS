...
#echo python sst_lat_l3u_l4.py AVHRR17_G 2004 04 04 >> run.sst_lat_l3u_l4.sh
#echo python sst_lat_l3u_l4.py AVHRR16_G 2004 04 04 >> run.sst_lat_l3u_l4.sh

bsub -q short-serial -W24:00 -R rusage[mem=60000] -M 60000 -oo run.1.log < run.sst_lat_l3u_l4.sh
